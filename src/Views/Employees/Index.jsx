...
import DivTable from '../../Components/DivAdd';
...
const Employees = () => {
  ...
  const getEmployees = async(page) =>{
   const res = await sendReques('GET','','/api/employess/page='+page,'');
     ...
     {employees.map( (row,i)=>(
      ...
      <i className='fa-solid fa-edit'></i> 
       ...
       <td>
        ...
        onClick={()=> deleteEmployees(row.id,row.name)}>
    ...
    <Modal title={title} modal={'modalEmployees'}>
     <div className='modal-body'>
      ...
      <DivInput type='text' icon='fa-user'
         value={name} className='form=control'placeholder='Name'
          required='required' ref={NameInput}
         handleChange={(e)=>setName(e.target.value)} />
         <DivInput type='email' icon='fa-at'
         value={email} className='form=control'placeholder='Email'
          required='required'  handleChange={(e)=>setEmail(e.target.value)} />
          <DivInput type='phone' icon='fa-phone'
         value={phone} className='form=control'placeholder='Phone'
          required='required'  handleChange={(e)=>setPhone(e.target.value)} />
